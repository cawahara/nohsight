...
Event.seed do |s|
   ...
   s.user_id      = 1
   s.title        = '京都観世会5月例会'
   s.start_date   = DateTime.new(2017, 5, 28, 11, 0o0)
   s.information  = ''
...
Event.seed do |s|
   ...
   s.user_id      = 3
   s.title        = '市民狂言会'
   s.start_date   = DateTime.new(2017, 6, 9, 19, 0o0)
...
Event.seed do |s|
   ...
   s.user_id      = 2
   s.title        = '県民のための能を知る会'
   s.start_date   = DateTime.new(2017, 6, 25, 16, 0o0)
   s.information  = ''
...
Event.seed do |s|
   ...
   s.user_id      = 1
   s.title        = '金春会定期能'
   s.start_date   = DateTime.new(2017, 7, 1, 17, 0o0)
   s.information  = ''
   s.official_url = ''
   s.published    = true
end
...
Event.seed do |s|
   ...
   s.start_date   = DateTime.new(2017, 8, 24, 11, 0o0)
   s.information  = ''
...
Event.seed do |s|
   ...
   s.start_date   = DateTime.new(2017, 9, 3, 13, 0o0)
